...
python export_inference_graph.py --input_type image_tensor --pipeline_config_path  ./ssd_resnet101_v1_fpn_shared_box_predictor_oid_512x512.config --trained_checkpoint_prefix ./models/retinanet_resnet101/model.ckpt-129207 --output_directory ./models/inference_model_retinanet
